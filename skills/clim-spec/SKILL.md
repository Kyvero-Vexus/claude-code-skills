...
python3 skills/clim-spec/scripts/clim_spec_lookup.py --query "make-pane|CLIM stream pane" --files '29*.html'
python3 skills/clim-spec/scripts/clim_spec_lookup.py --query "incremental redisplay|updating-output" --files '21*.html'
```
